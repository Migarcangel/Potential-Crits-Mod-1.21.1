...
import com.migar.potentialcrits.command.ProgressionCommand;
...
import com.migar.potentialcrits.item.ModCreativeModeTabs;
...
public class PotentialCrits {
    ...
    public PotentialCrits(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Register Commands
        NeoForge.EVENT_BUS.register(ProgressionCommand.class);
