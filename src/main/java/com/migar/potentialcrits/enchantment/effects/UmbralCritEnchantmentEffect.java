...
public record UmbralCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<UmbralCritEnchantmentEffect> CODEC = MapCodec.unit(UmbralCritEnchantmentEffect::new);
