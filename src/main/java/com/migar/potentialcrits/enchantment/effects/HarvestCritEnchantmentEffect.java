...
public record HarvestCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<HarvestCritEnchantmentEffect> CODEC = MapCodec.unit(HarvestCritEnchantmentEffect::new);
