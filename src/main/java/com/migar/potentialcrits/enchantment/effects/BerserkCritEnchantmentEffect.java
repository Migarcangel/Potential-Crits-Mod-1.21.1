...
public record BerserkCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<BerserkCritEnchantmentEffect> CODEC = MapCodec.unit(BerserkCritEnchantmentEffect::new);
