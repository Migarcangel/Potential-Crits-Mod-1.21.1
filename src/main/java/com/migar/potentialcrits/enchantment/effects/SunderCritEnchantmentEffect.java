...
public record SunderCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<SunderCritEnchantmentEffect> CODEC = MapCodec.unit(SunderCritEnchantmentEffect::new);
