...
public record TrueCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<TrueCritEnchantmentEffect> CODEC = MapCodec.unit(TrueCritEnchantmentEffect::new);
