...
public record WaterCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<WaterCritEnchantmentEffect> CODEC = MapCodec.unit(WaterCritEnchantmentEffect::new);
