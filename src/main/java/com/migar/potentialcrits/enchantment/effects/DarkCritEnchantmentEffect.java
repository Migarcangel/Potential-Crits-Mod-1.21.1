...
public record DarkCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<DarkCritEnchantmentEffect> CODEC = MapCodec.unit(DarkCritEnchantmentEffect::new);
