...
public record GroundCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<GroundCritEnchantmentEffect> CODEC = MapCodec.unit(GroundCritEnchantmentEffect::new);
