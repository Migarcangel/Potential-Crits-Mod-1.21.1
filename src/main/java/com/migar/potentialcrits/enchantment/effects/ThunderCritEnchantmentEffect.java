...
public record ThunderCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<ThunderCritEnchantmentEffect> CODEC = MapCodec.unit(ThunderCritEnchantmentEffect::new);
