...
public record SuperCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<SuperCritEnchantmentEffect> CODEC = MapCodec.unit(SuperCritEnchantmentEffect::new);
