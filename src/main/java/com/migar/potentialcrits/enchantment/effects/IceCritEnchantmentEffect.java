...
public record IceCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<IceCritEnchantmentEffect> CODEC = MapCodec.unit(IceCritEnchantmentEffect::new);
