...
public record ShieldCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<ShieldCritEnchantmentEffect> CODEC = MapCodec.unit(ShieldCritEnchantmentEffect::new);
