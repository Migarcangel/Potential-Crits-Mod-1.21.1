...
public record SmashCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<SmashCritEnchantmentEffect> CODEC = MapCodec.unit(SmashCritEnchantmentEffect::new);
