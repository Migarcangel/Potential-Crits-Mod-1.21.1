...
public record VampireCritEnchantmentEffect() implements EnchantmentEntityEffect {
    public static final MapCodec<VampireCritEnchantmentEffect> CODEC = MapCodec.unit(VampireCritEnchantmentEffect::new);
